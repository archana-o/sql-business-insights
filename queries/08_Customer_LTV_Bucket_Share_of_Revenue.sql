...
-- Sanity check: sum(total_revenue) across all customers equals revenue from ecom.orders (excluding cancelled),
                 within 0.5%. ltv_bucket_share_of_revenue summed across distinct buckets equals 1.0 -> confirmed
